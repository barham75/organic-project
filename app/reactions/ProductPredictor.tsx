  ...
  return (
    <section className="mt-4 border-l-4 border-amber-400 bg-amber-50 p-4">
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-2">
        <Editor title="Starting material" ref={substrateRef} />
        <Editor title="Expected product" ref={productRef} />
      </div>
...
const Editor = forwardRef<HTMLIFrameElement, { title: string }>(function Editor({ title }, ref) {
  return (
    <div>
